            ...
            return (
              ...
              >
                ...
                <div className="flex-shrink-0 flex items-center justify-center md:w-32 mt-6 md:mt-0">
                  <div className="p-2 bg-koetsier-gold/10 rounded-full text-koetsier-gold group-hover:bg-koetsier-gold group-hover:text-white transition-colors duration-300">
